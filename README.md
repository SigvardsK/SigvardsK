...
|---------|-------------|
| [`klirs`](https://github.com/SigvardsK/klirs) | Self-hostable AML/KYC screening that refuses to silently clear. Playwright captures timestamped evidence per check across sanctions / PEP / registry / adverse-media sources; tri-state classifier surfaces ambiguity for human review; PDF + pre-filled Latvian Bar annexes ready for filing. Hosted at [klirs.eu](https://klirs.eu). |
